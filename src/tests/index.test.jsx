...
jest.mock("../pages/LoginPage.jsx", () => () => <div>Login Page Mock</div>); 
jest.mock("../pages/TarefasPage.jsx", () => () => <div>Tarefas Page Mock</div>); 
jest.mock("../pages/RelatoriosPage.jsx", () => () => <div>Relatórios Page Mock</div>); 
